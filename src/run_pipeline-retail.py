...
# target_col is 'sales' — this adds lag and rolling features
df_features = build_xgboost_features(df, target_col='sales')
print(df_features.head())

# Split into X (features) and y (target)
feature_cols = ['day_of_week', 'month_num', 'lag_1', 'lag_7', 'lag_30', 'rolling_mean_7',
                'price', 'promo']  # add any extra columns you want
